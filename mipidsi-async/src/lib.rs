    ...
    RST: OutputPin,
{
    ...
    /// ```
    pub async fn set_orientation(&mut self, orientation: options::Orientation) -> Result<(), Error> {
    ...
    pub async fn set_pixel(&mut self, x: u16, y: u16, color: M::ColorFormat) -> Result<(), Error> {
        ...
        self.model
            .write_pixels(&mut self.dcs, core::iter::once(color)).await?;
    ...
    /// using this method.
    pub async fn set_vertical_scroll_offset(&mut self, offset: u16) -> Result<(), Error> {
    ...
    ///
    pub async fn sleep<D: DelayNs>(&mut self, delay: &mut D) -> Result<(), Error> {
    ...
    ///
    pub async fn wake<D: DelayNs>(&mut self, delay: &mut D) -> Result<(), Error> {
...
pub mod _mock {
    ...
    impl AsyncWriteOnlyDataCommand for MockDisplayInterface {
