...
impl Model for GC9A01 {
        ...
        DI: AsyncWriteOnlyDataCommand,
    {
        ...
        dcs.write_raw(0xF0, &[0x45, 0x09, 0x08, 0x08, 0x26, 0x2A]).await?; // gamma 1
        dcs.write_raw(0xF1, &[0x43, 0x70, 0x72, 0x36, 0x37, 0x6f]).await?; // gamma 2
        dcs.write_raw(0xF2, &[0x45, 0x09, 0x08, 0x08, 0x26, 0x2A]).await?; // gamma 3
        dcs.write_raw(0xF3, &[0x43, 0x70, 0x72, 0x36, 0x37, 0x6f]).await?; // gamma 4
        ...
        dcs.write_raw(0x64, &[0x28, 0x29, 0xF1, 0x01, 0xF1, 0x00, 0x07]).await?;
        dcs.write_raw(
            0x66,
        ...
        dcs.write_raw(0x74, &[0x10, 0x85, 0x80, 0x00, 0x00, 0x4E, 0x00]).await?;
